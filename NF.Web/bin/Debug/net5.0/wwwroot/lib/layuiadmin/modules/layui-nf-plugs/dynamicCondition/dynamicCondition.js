 ...
 */
layui.extend({
    dcConfig: 'layui-nf-plugs/dynamicCondition/dcConfig'
}).define(['jquery', 'table', 'form', 'laydate', 'dcConfig'], function (exports) {
    "use strict";
    layui.link(layui.cache.base + 'layui-nf-plugs/dynamicCondition/dc.css');
    ...
    var createInstance = function (_config) {
        ...
        instance.addRow = function (parentRowJq) {
            ...
            if (parentRowJq) {
                parentRowObj = {
                    rowlevel: parseInt(parentRowJq.attr("rowlevel"))
            ...
            var conditionFieldHtml = $(instance.conditionFieldHtml);
            conditionField.append(conditionFieldHtml);
            //操作
            ...
            //加入mousedown与mouseup 解决下拉框事件问题
            logicalOperator.on("mousedown", function (e) {
                var divsel = $(e.currentTarget).children("div.layui-unselect.layui-form-select");
                if (!divsel.hasClass("layui-form-selected")) {
                    $(e.currentTarget).children("div.layui-unselect.layui-form-select")
                        .addClass("layui-form-selected");
                }
            });
            logicalOperator.on("mouseup", function (e) {
                $("div.layui-unselect.layui-form-select.layui-form-selected").each(function () {
                    $(this).removeClass("layui-form-selected");
                });

            });
            conditionField.on("mousedown", function (e) {
                var divsel = $(e.currentTarget).children("div.layui-unselect.layui-form-select");
                if (!divsel.hasClass("layui-form-selected")) {
                    $(e.currentTarget).children("div.layui-unselect.layui-form-select")
                        .addClass("layui-form-selected");
            ...
            conditionField.on("mouseup", function (e) {
                $("div.layui-unselect.layui-form-select.layui-form-selected").each(function () {
                    $(this).removeClass("layui-form-selected");
                });

            });
            conditionOption.on("mousedown", function (e) {
                var divsel = $(e.currentTarget).children("div.layui-unselect.layui-form-select");
                if (!divsel.hasClass("layui-form-selected")) {
                    $(e.currentTarget).children("div.layui-unselect.layui-form-select")
                        .addClass("layui-form-selected");
            ...
            conditionOption.on("mouseup", function (e) {
                $("div.layui-unselect.layui-form-select.layui-form-selected").each(function () {
                    $(this).removeClass("layui-form-selected");
                });

            });
            conditionValue.on("mousedown", function (e) {
                var divsel = $(e.currentTarget).children("div.layui-unselect.layui-form-select");
                if (!divsel.hasClass("layui-form-selected")) {
                    $(e.currentTarget).children("div.layui-unselect.layui-form-select")
                        .addClass("layui-form-selected");
            ...
            conditionValue.on("mouseup", function (e) {
                $("div.layui-unselect.layui-form-select.layui-form-selected").each(function () {
                    $(this).removeClass("layui-form-selected");
                });
        ...
        instance.buildConditionHtmlForPopup = function () {
            if ($("#query" + instance.conditionContainerId).size() == 0) {
    ...
    var defaultValueConfig = {
        ...
        opsMap: {
            "equal": "等于", "like": "包含", "between": "范围"
            , "start": "开头字符", "end": "结尾字符", "unequal": "不等于", "empty": "为空", "notempty": "不为空"
        }, //操作选项列表
    ...
    function aotuSetParentWidth(parentRowJq) {
        if (parentRowJq && parentRowJq.size() > 0) {
