...
ALTER TABLE [dbo].[ContSubjectMatter] WITH NOCHECK ADD
CONSTRAINT [FK_ContSubjectMatter_BcInstance] FOREIGN KEY ([BcInstanceId]) REFERENCES [dbo].[BcInstance] ([Id]) NOT FOR REPLICATION
ALTER TABLE [dbo].[ContSubjectMatter] NOCHECK CONSTRAINT [FK_ContSubjectMatter_BcInstance]
ALTER TABLE [dbo].[ContSubjectMatter] WITH NOCHECK ADD
CONSTRAINT [FK_ContSubjectMatter_ContractInfo] FOREIGN KEY ([ContId]) REFERENCES [dbo].[ContractInfo] ([Id]) NOT FOR REPLICATION
