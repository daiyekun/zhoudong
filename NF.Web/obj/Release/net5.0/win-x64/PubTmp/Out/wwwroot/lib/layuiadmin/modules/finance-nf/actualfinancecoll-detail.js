...
layui.define(['table', 'form'], function (exports) {
            ...
            elem: '#NF-ActualBuild-InvoiceCheck'
              , url: '/Finance/ContActualFinance/GetInvoiceByContId?contId=' + contId + '&actId=' + Id + '&rand=' + wooutil.getRandom()
               , cols: [[
                   ...
                   , { field: 'CheckAmountThod', title: '本次收款金额', width: 150 }
    ...
    table.render({
        ...
        //, defaultToolbar: ['filter']
           , cols: [[
               ...
               , { field: 'SurplusAmountThod', title: '可核销', width: 130 }
    ...
    /**
       ...
       **/
    function editFunc() {
        var ress = getUpdatePermission("addOrUpdateActFinanceColl");
        if (ress.RetValue == 0) {
            parent.layer.title("修改实际资金", $index);
            parent.layer.iframeSrc($index, '/Finance/ContActualFinance/ActualFinanceCollBuild?Id=' + Id + "&contId=" + contId + "&rand=" + wooutil.getRandom());
        } else {
    ...
    function updateState(state) {
        admin.req({
            url: '/Finance/ContActualFinance/UpdateField'
               ...
               , done: function (res) {
                   wootool.handlesucc({ msg: '操作成功！', time: 400, index: $index, tableId: 'NF-ActualFinanceColl-Index' });
               }
        });
    }
    /**
    ...
    **/
    var active = {
        ...
        edit: function () {
            ...
            var ress = getUpdatePermission("confirmOrBackActFinanceColl");
            if (ress.RetValue == 0) {
                updateState(2);
            } else {
                return layer.alert("无权限");
...
/***********************附件信息-end***************************************************************************************************/
    ...
    exports('actualfinancecollDetail', {});
});