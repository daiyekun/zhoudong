...
GO
ALTER TABLE [dbo].[Bidlabel] WITH NOCHECK ADD CONSTRAINT [FK_Bidlabel_Questioning] FOREIGN KEY ([QuesId]) REFERENCES [dbo].[Questioning] ([Id]) NOT FOR REPLICATION
GO
ALTER TABLE [dbo].[Bidlabel] WITH NOCHECK ADD CONSTRAINT [FK_Bidlabel_OpenBid] FOREIGN KEY ([WinningUnit]) REFERENCES [dbo].[OpenBid] ([Id]) NOT FOR REPLICATION
GO
