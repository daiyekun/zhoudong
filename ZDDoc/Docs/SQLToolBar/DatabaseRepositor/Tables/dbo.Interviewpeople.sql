...
GO
ALTER TABLE [dbo].[Interviewpeople] WITH NOCHECK ADD CONSTRAINT [FK_Interviewpeople_Questioning] FOREIGN KEY ([QuesId]) REFERENCES [dbo].[Questioning] ([Id]) NOT FOR REPLICATION
GO
