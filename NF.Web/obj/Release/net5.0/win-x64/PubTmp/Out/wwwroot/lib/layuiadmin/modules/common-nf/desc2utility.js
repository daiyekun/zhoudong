layui.define(['table', 'laydate', 'form'], function (exports) {
    ...
    var desc2utility = {
        stateEvent: function (param) {
            ...
            //状态流转
            $(".dow2").on("click", ".layui-select-title", function (e) {
                ...
                if (checkData.length != 1) {
                ...
                } else if (checkData[0].Mystate == 4 || cate != "SuperAdministrator" ) {//已终止Or已作废Or已完成
                    ...
                    switch (checkData[0].Mystate) {
                        ...
                        case 3:
                        case "3": {
                            $(".datastate").append('<dd lay-event="stateChange" flowitem="4" tostate="4"><i class="layui-icon layui-icon-edit"></i>已完成-->已关闭</dd>');
                        }
                            break;
                        default:
        ...
        updateSate: function (param) {
            ...
            **/
            //否则弹框修改时间等
            desc2utility.showHideField(flowitem);
    ...
    exports('desc2utility', desc2utility);
});