...
ALTER TABLE [dbo].[TenderInfor] WITH NOCHECK ADD
CONSTRAINT [FK_TenderInfor_UserInfor] FOREIGN KEY ([CreateUserId]) REFERENCES [dbo].[UserInfor] ([Id]) NOT FOR REPLICATION
ALTER TABLE [dbo].[TenderInfor] NOCHECK CONSTRAINT [FK_TenderInfor_UserInfor]
ALTER TABLE [dbo].[TenderInfor] WITH NOCHECK ADD
CONSTRAINT [FK_TenderInfor_ProjectManager] FOREIGN KEY ([ProjectId]) REFERENCES [dbo].[ProjectManager] ([Id])
GO
