...
layui.define(['jquery'], function (exports) {
    ...
    var myConfig  = {
            ...
            displayModel: 'popup',//显示模型。取值：'popup'/'unpopup'。 默认"popup"点击后提出查询条件设置窗口。unpopup模式则不弹出窗口，直接在界面上设置条件。
    		counts: 3,//默认初始化条件数。
           ...
           opsList: ["equal", "like", "between"],//["equal","like","between","unequal","empty","notempty"],//操作选项列表
