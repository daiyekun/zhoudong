...
layui.define(['table', 'form',  'flowEventHandler'], function (exports) {
   ...
   , flowEventHandler = layui.flowEventHandler;
    ...
    var _reqUrl = '/WorkFlow/AppInst/GetAppProcessedList?rand=' + wooutil.getRandom();
    if (searchType != undefined && searchType === "1") {
        _reqUrl = _reqUrl + "&search=" + searchType;
    }
    table.render({
        elem: '#NF-AppProcessedList'
       , url: _reqUrl
       , toolbar: '#toolAppProcessed'
       ...
       , cols: [[
           ...
           , { field: 'CompleteDateTime', title: '审批时间', width: 130 }
    ...
    /**工具栏操作**/
    table.on('tool(NF-AppProcessedList)', function (obj) {
        switch (obj.event) {
            case "showView"://查看
