layui.define(['table', 'laydate', 'form'], function (exports) {
    ...
    var gbdescutility = {
        stateEvent: function (param) {
            ...
            $(".downpanel").on("click", ".layui-select-title", function (e) {
                ...
                if (checkData.length !== 1) {
                ...
                } else if (checkData[0].Mystate == 2 || checkData[0].Mystate == 3 || checkData[0].Mystate == 6) {//已终止Or已作废Or已完成
                    ...
                    switch (checkData[0].Mystate) {
                        ...
                        case "3"://当前状态“未执行”
                            {
                                $(".datastate").append('<dd lay-event="stateChange" flowitem="1" tostate="1"><i class="layui-icon layui-icon-edit"></i>已完成-->等待</dd>');
                                $(".datastate").append('<dd lay-event="stateChange" flowitem="5" tostate="3"><i class="layui-icon layui-icon-edit"></i>已完成-->关闭</dd>');
                            }
                            break;
                        case 1:
                        case "1":  //当前状态“执行中”
        ...
        updateSate: function (param) {
            ...
            **/
            //否则弹框修改时间等
           // gbgbdescutility.showHideField(flowitem);
    ...
    exports('gbdescutility', gbdescutility);
});