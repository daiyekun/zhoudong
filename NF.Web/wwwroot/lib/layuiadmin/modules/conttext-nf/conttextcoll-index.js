...
layui.define(['table', 'form', 'wordAddin'], function (exports) {
    ...
    var $htcols = [
       ...
       /* , { field: '', title: '下载Pdf', width: 120, templet: '#downloadPdf' }*/
    ...
    //列表
    table.render({
        elem: '#NF-ContTextColl-Index'
        , url: '/ContractDraft/ContText/GetMainList?requestType=0&rand=' + wooutil.getRandom()
   ...
   **/
    ...
    **/
    ...
    /*********************************公共方法-end***********************************************************/
    //监听表格排序
    table.on('sort(NF-ContTextColl-Index)', function (obj) {
        table.reload('NF-ContTextColl-Index', { //testTable是表格容器id
    ...
    **/
    var toolEvent = {
        search: function () {//查询
            ...
            table.reload('NF-ContTextColl-Index', {
                page: { curr: 1 }
                , where: {
        ...
        OnLineView: function () {
            var checkStatus = table.checkStatus("NF-ContTextColl-Index")
        ...
        openAddSeal: function (obj) {
            ...
            var ress = wooutil.requestpremission({
                ...
                data: {
                    FuncCode: 'collconttextseal'//收款合同归档权限
                }
            });
            if (ress.RetValue == 0) {
    ...
    table.on('toolbar(NF-ContTextColl-Index)', function (obj) {
        switch (obj.event) {
            case 'search':
...
**/
    ...
    table.on('tool(NF-ContTextColl-Index)', function (obj) {
        switch (obj.event) {
            case "contdetail":
