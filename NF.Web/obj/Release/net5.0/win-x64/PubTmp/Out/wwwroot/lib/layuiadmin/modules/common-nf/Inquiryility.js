...
layui.define(['table', 'form'], function (exports) {
    ...
    var contractutility = {
        ...
        updateSate: function (param) {
            ...
            admin.req({
                url: param.url
                , data: { Id: checkData[0].Id, fieldName: 'InState', fieldVal: state }
                , done: function (res) {
