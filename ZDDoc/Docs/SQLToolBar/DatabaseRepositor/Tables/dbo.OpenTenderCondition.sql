...
GO
ALTER TABLE [dbo].[OpenTenderCondition] WITH NOCHECK ADD CONSTRAINT [FK_OpenTenderCondition_Inquiry] FOREIGN KEY ([LnquiryId]) REFERENCES [dbo].[Inquiry] ([Id]) NOT FOR REPLICATION
GO
ALTER TABLE [dbo].[OpenTenderCondition] WITH NOCHECK ADD CONSTRAINT [FK_OpenTenderCondition_OpenTenderCondition] FOREIGN KEY ([unit]) REFERENCES [dbo].[Company] ([Id]) NOT FOR REPLICATION
GO
