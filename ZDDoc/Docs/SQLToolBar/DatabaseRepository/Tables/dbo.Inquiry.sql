...
ALTER TABLE [dbo].[Inquiry] WITH NOCHECK ADD
CONSTRAINT [FK_Inquiry_Company] FOREIGN KEY ([Zbdw]) REFERENCES [dbo].[Company] ([Id]) NOT FOR REPLICATION
ALTER TABLE [dbo].[Inquiry] NOCHECK CONSTRAINT [FK_Inquiry_Company]

ALTER TABLE [dbo].[Inquiry] ADD
CONSTRAINT [FK_Inquiry_UserInfor] FOREIGN KEY ([CreateUserId]) REFERENCES [dbo].[UserInfor] ([Id])
ALTER TABLE [dbo].[Inquiry] ADD
CONSTRAINT [FK_Inquiry_Department] FOREIGN KEY ([ContractExecuteBranch]) REFERENCES [dbo].[Department] ([Id])
ALTER TABLE [dbo].[Inquiry] ADD
CONSTRAINT [FK_Inquiry_Inquiry] FOREIGN KEY ([ProjectName]) REFERENCES [dbo].[ProjectManager] ([Id])
GO
