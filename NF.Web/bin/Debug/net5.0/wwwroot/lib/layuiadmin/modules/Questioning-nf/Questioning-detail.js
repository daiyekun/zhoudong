...
*收款合同查看
*/
layui.define(['table','form', 'tableSelect', 'selectnfitem'
    ...
    /***********************招标人-begin***************************************************************************************************/
        table.render({
            ...
            , cols: [[
                ...
                , { field: 'InqName', title: '洽谈人', width: 200, event: 'SelectzbUSname' }
        ...
        var planXJZBREvent = {
            ...
            batchdel: function () {
                /// <summary>列表头部-批量删除</summary>
                wooutil.deleteDatas({ tableId: 'NF-contplanKbqk', url: '/Questioning/Interviewpeople/Deletekb', nopage: true });
            },
            tooldel: function (obj) {
                /// <summary>列表操作栏-删除</summary>
                ///<param name='obj'>删除数据对象</param>
                wooutil.deleteInfo({ tableId: "NF-contplanKbqk", data: obj, url: '/Questioning/Interviewpeople/Deletekb', nopage: true });
            }
        };
        //合同计划资金头部工具栏
        ...
        table.render({
            ...
            , cols: [[
                ...
                , { field: 'Id', title: 'Id', width: 50, hide: true }
                , { field: 'Name', title: '名称', width: 200, edit: 'text', fixed: 'left' }
                , { field: 'WinningUnitName', title: '洽谈情况单位', width: 200, templet: '#compTpls' }
                , { field: 'WinningUnit', title: 'SuccessUntiId', width: 50, hide: true }
                , { field: 'BidPricesthis', title: '洽谈总价', edit: 'text', width: 200 }
                , { field: 'BidPricethis', title: '洽谈单价', edit: 'text', width: 200 }
                , { field: 'BidUserName', title: '洽谈人员', width: 200, event: 'SelectzbUSname' }
...
**/
        function opencompview(obj) {
            parent.layer.open({
                type: 2
                , title: '查看详情'
                , content: '/Company/Customer/Detail?Id=' + obj.data.Zbdwid + "&rand=" + wooutil.getRandom()
                , maxmin: true
                , area: ['60%', '80%']
                , btnAlign: 'c'
                , skin: "layer-nf-nfskin"
                    ...
                    layer.open({
                        ...
                        , yes: function (index, layero) {
                            ...
                            iframeWindow.layui.form.on('submit(' + submitID + ')', function (obj) {
                                wooutil.OpenSubmitForm({
                                    url: '/Questioning/Winning/ShowView1',
                                    data: obj.field,
                                    table: table,
                                    index: index,
                                    tableId: 'NF-Cargo'
