...
GO
ALTER TABLE [dbo].[SuccessfulBidderLable] WITH NOCHECK ADD CONSTRAINT [FK_SuccessfulBidderLable_TenderInfor] FOREIGN KEY ([SuccessUntiId]) REFERENCES [dbo].[OpeningSituationInfor] ([Id]) NOT FOR REPLICATION
GO
ALTER TABLE [dbo].[SuccessfulBidderLable] WITH NOCHECK ADD CONSTRAINT [FK_SuccessfulBidderLable_TenderInfor1] FOREIGN KEY ([TenderId]) REFERENCES [dbo].[TenderInfor] ([Id]) NOT FOR REPLICATION
GO
