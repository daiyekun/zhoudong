...
layui.define(['table', 'form', 'wordAddin', "tableSelect", "treeSelect"], function (exports) {
    ...
    layui.use(['laydate', 'nfcontents', 'commonnf', 'treeSelect'], function () {
        ...
        commonnf.getdatadic({ dataenum: 32, selectEl: "#QueType" });
        //目录
...
**/
        ...
        **/
        if (contId !== "" && contId !== undefined && contId !== 0) {
            admin.req({
                url: '/Questioning/Questioning/ShowView',
    ...
    table.render({
        ...
        , url: '/Questioning/OpenBid/GetKbqkList?contId=' + contId + '&rand=' + wooutil.getRandom()
        ...
        , cols: [[
            ...
            , { field: 'UnitName', title: '单位', fixed: 'left', event: 'SelectPJname' }
            , { field: 'Unit', title: 'ID', width: 120, hide: true }
            , { field: 'TotalPricesthis', title: '洽谈价', width: 200, edit: 'text' }
    ...
    var planXJQKEvent = {
        add: function () {
            wooutil.OpenSubmitForm({
                url: '/Questioning/OpenBid/SaveKbqk?contId=' + contId,
                //data: obj.field,
                table: table,
                index: 10,
            ...
            if (isupdate) {
                admin.req({
                    url: '/Questioning/OpenBid/SaveData?contId=' + contId,
        ...
        batchdel: function () {
            ...
            wooutil.deleteDatas({ tableId: 'NF-contplanKbqk', url: '/Questioning/OpenBid/Deletekb', nopage: true });
        },
        tooldel: function (obj) {
            /// <summary>列表操作栏-删除</summary>
            ///<param name='obj'>删除数据对象</param>
            wooutil.deleteInfo({ tableId: "NF-contplanKbqk", data: obj, url: '/Questioning/OpenBid/Deletekb', nopage: true });
        }, toolsava: function (obj) {
            $("#Zbdw").val(obj.data.Unit);//ZBDWID
            $("#Zje").val(obj.data.TotalPricethis);//ZJ
            admin.req({
                url: '/Questioning/Bidlabel/SaveBZData?contId=' + obj.data.Id,
                type: 'POST',
                done: function (res) {
                    //清空变量，防止重复提交
                    //isupdate = false;
    ...
    table.render({
        elem: '#NF-contplanZbr'
        , url: '/Questioning/Interviewpeople/GetKbqkList?contId=' + contId + '&rand=' + wooutil.getRandom()
        ...
        , cols: [[
            ...
            , { field: 'InquirerName', title: '洽谈人', width: 200, event: 'SelectzbUSname' }
    ...
    var planXJZBREvent = {
        add: function () {
            wooutil.OpenSubmitForm({
                url: '/Questioning/Interviewpeople/SaveKbr?contId=' + contId,
                //data: obj.field,
                table: table,
                index: 10,
            ...
            if (isupdate) {
                admin.req({
                    url: '/Questioning/Interviewpeople/SaveData?contId=' + contId,
                    data: { subs: updatedata },
                    type: 'POST',
                    done: function (res) {
                        //清空变量，防止重复提交
        ...
        batchdel: function () {
            /// <summary>列表头部-批量删除</summary>
            wooutil.deleteDatas({ tableId: 'NF-contplanZbr', url: '/Questioning/Interviewpeople/Deletekb', nopage: true });
        },
        tooldel: function (obj) {
            /// <summary>列表操作栏-删除</summary>
            ///<param name='obj'>删除数据对象</param>
            wooutil.deleteInfo({ tableId: "NF-contplanZbr", data: obj, url: '/Questioning/Interviewpeople/Deletekb', nopage: true });
        }
    };
    //合同计划资金头部工具栏
    ...
    table.render({
        elem: '#NF-contplanZbdw'
         , url: '/Questioning/Bidlabel/GetKbqkList?contId=' + contId + '&rand=' + wooutil.getRandom()
        ...
        , cols: [[
            ...
            , { field: 'Id', title: 'Id', width: 50, hide: true }
            , { field: 'Name', title: '名称', width: 200, edit: 'text', fixed: 'left' }
            , { field: 'WinningUnitName', title: '洽谈情况单位', width: 200, edit: 'text', event: 'SelectzbPJname' }
            , { field: 'WinningUnit', title: 'SuccessUntiId', width: 50, hide: true }
            , { field: 'BidPricesthis', title: '洽谈总价', edit: 'text', width: 200 }
            , { field: 'BidPricethis', title: '中标单价', edit: 'text', width: 200 }
            , { field: 'BidUserName', title: '洽谈单价', width: 200, event: 'SelectzbUSname' }
    ...
    var planxjZbdwEvent = {
        add: function () {
            wooutil.OpenSubmitForm({
                url: '/Questioning/Bidlabel/SaveKbr?contId=' + contId,
                //data: obj.field,
                table: table,
                index: 10,
            ...
            if (isupdate) {
                admin.req({
                    url: '/Questioning/Bidlabel/SaveData?contId=' + contId,
                    data: { subs: updatedata },
                    type: 'POST',
                    done: function (res) {
                        //清空变量，防止重复提交
        ...
        batchdel: function () {
            /// <summary>列表头部-批量删除</summary>
            wooutil.deleteDatas({ tableId: 'NF-contplanZbdw', url: '/Questioning/Bidlabel/Deletekb', nopage: true });
        },
        tooldel: function (obj) {
            /// <summary>列表操作栏-删除</summary>
            ///<param name='obj'>删除数据对象</param>
            wooutil.deleteInfo({ tableId: "NF-contplanZbdw", data: obj, url: '/Questioning/Bidlabel/Deletekb', nopage: true });
        }
    };
    //合同计划资金头部工具栏
    ...
    table.on('tool(NF-contplanZbdw)', function (obj) {
        ...
        switch (obj.event) {
            ...
            case "SelectzbPJname":
                {
                    var field = $(this).data('field');
                    var _url = '/Questioning/Bidlabel/GetZbList?contId=' + contId + '&selitem=' + true;
                    tableSelect.render({
                        elem: this.lastChild,
                        searchKey: 'keyWord',
                        searchPlaceholder: '关键词搜索',
    ...
    table.render({
        ...
        , url: '/Questioning/QuestioningAttachment/GetList?contId=' + contId + '&rand=' + wooutil.getRandom()
    ...
    var attacXJFJEvent = {
        ...
        add: function () {
            ...
            layer.open({
                type: 2
                , title: '新建附件'
                , content: '/Questioning/QuestioningAttachment/Build'
                // , maxmin: false
                , area: ['800px', '80%']
                , btn: ['确定', '取消']
                , btnAlign: 'c'
                ...
                , yes: function (index, layero) {
                    ...
                    iframeWindow.layui.form.on('submit(' + submitID + ')', function (obj) {
                        wooutil.OpenSubmitForm({
                            url: '/Questioning/QuestioningAttachment/Save',
                            data: obj.field,
                            table: table,
                            index: index,
        ...
        batchdel: function () {
            /// <summary>列表头部-批量删除</summary>
            wooutil.deleteDatas({ tableId: 'NF-ContAttachment', table: table, url: '/Questioning/QuestioningAttachment/Delete', nopage: true });
        },
        ...
        tooldel: function (obj) {
            /// <summary>列表操作栏-删除</summary>
            ///<param name='obj'>删除数据对象</param>
            wooutil.deleteInfo({ tableId: "NF-ContAttachment", data: obj, url: '/Questioning/QuestioningAttachment/Delete', nopage: true });
        },
        tooledit: function (obj) {
            ...
            layer.open({
                type: 2
                , title: '修改附件'
                , content: '/Questioning/QuestioningAttachment/Build?Id=' + obj.data.Id + "&rand=" + wooutil.getRandom()
                //, maxmin: true
                , area: ['800px', '80%']
                , btn: ['确定', '取消']
                , btnAlign: 'c'
                ...
                , yes: function (index, layero) {
                    ...
                    iframeWindow.layui.form.on('submit(' + submitID + ')', function (obj) {
                        wooutil.OpenSubmitForm({
                            url: '/Questioning/QuestioningAttachment/UpdateSave',
                            data: obj.field,
                            table: table,
                            index: index,
                            tableId: 'NF-ContAttachment'
    ...
    table.render({
        elem: '#NF-Cargo'
        , url: '/Questioning/Winning/GetActListByContId?contId=' + contId + '&rand=' + wooutil.getRandom()
    ...
    var attachmentEvent = {
        ...
        add: function () {
            ...
            layer.open({
                type: 2
                , title: '新建'
                , content: '/Questioning/Winning/Build'
                // , maxmin: false
                , area: ['60%', '80%']
                , btn: ['确定', '取消']
                , btnAlign: 'c'
                ...
                , yes: function (index, layero) {
                    ...
                    iframeWindow.layui.form.on('submit(' + submitID + ')', function (obj) {
                        ...
                        table.reload('NF-Cargo', {
                            url: '/Questioning/Winning/ShowView1',//+ '&rand=' + wooutil.getRandom(),
                        });
                        return false;
                    });
                    submit.trigger('click');
                ...
                success: function (layero, index) {
                    ...
                    if (isupdate) {
                        admin.req({
                            url: '/Questioning/Winning/SaveData?contId=' + contId,
                            data: { subs: updatedata },
                            type: 'POST',
                            done: function (res) {
                                //清空变量，防止重复提交
        ...
        batchdel: function () {
            /// <summary>列表头部-批量删除</summary>
            wooutil.deleteDatas({ tableId: 'NF-Cargo', table: table, url: '/Questioning/Winning/Delete', nopage: true });
        },
        tooldownload: function (obj) {
            wooutil.download({
                Id: obj.data.Id,
        ...
        tooldel: function (obj) {
            /// <summary>列表操作栏-删除</summary>
            ///<param name='obj'>删除数据对象</param>
            wooutil.deleteInfo({ tableId: "NF-Cargo", data: obj, url: '/Questioning/Winning/Delete', nopage: true });
        },
        tooledit: function (obj) {
            ///<summary>修改</summary>
            ///<param name='obj'>修改数据对象</param>
