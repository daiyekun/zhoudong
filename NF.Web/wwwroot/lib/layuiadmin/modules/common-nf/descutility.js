layui.define(['table', 'laydate', 'form'], function (exports) {
    ...
    var descutility = {
        stateEvent: function (param) {
            ...
            $(".downpanel").on("click", ".layui-select-title", function (e) {
                ...
                if (checkData.length !== 1) {
                ...
                } else if (checkData[0].Mystate == 3 ) {//已终止Or已作废Or已完成
                    ...
                    switch (checkData[0].Mystate) {
                        ...
                        case "0"://当前状态“未执行”
                            {
                                ...
                                $(".datastate").append('<dd lay-event="stateChange" flowitem="2" tostate="2"><i class="layui-icon layui-icon-edit"></i>等待-->未执行</dd>');
                                $(".datastate").append('<dd lay-event="stateChange" flowitem="3" tostate="3"><i class="layui-icon layui-icon-edit"></i>等待-->已完成</dd>');
                        ...
                        case "1":
                            {
                                $(".datastate").append('<dd lay-event="stateChange" flowitem="3" tostate="3"><i class="layui-icon layui-icon-edit"></i>已提醒-->已完成</dd>');
                            }
                            break;
                        case 2:
                        case "2":  //当前状态“执行中”
                            {
                                ...
                                $(".datastate").append('<dd lay-event="stateChange" flowitem="3" tostate="3"><i class="layui-icon layui-icon-edit"></i>未执行-->已完成</dd>');
                            }
                            break;
        ...
        updateSate: function (param) {
            ...
            **/
            //否则弹框修改时间等
           // descutility.showHideField(flowitem);
    ...
    exports('descutility', descutility);
});