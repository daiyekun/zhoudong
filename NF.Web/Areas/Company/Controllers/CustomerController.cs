...
namespace NF.Web.Areas.Company.Controllers
{
    ...
    public class CustomerController : NfBaseController
    {
        ...
        public CustomerController(ICompanyService ICompanyService, ICompContactService ICompContactService, 
        ...
        [NfCustomActionFilter("新增客户", OptionLogTypeEnum.Add, "新增客户",true)]
        /// <summary>
        /// 保存
        /// </summary>
        ...
        public IActionResult Save(CompanyDTO info)
        {
            ...
            if (LhCode.LhLicense.CustomerCoreStyle == 1)
            {
                saveInfo.Code = _INoHipler.CustrNo(saveInfo.CompClassId??0,0);
            }
        ...
        [NfCustomActionFilter("修改客户", OptionLogTypeEnum.Update, "修改客户", true)]
        /// <summary>
        /// 修改保存
        /// </summary>
        /// <param name="info">保存信息对象</param>
        ...
        private Expression<Func<Model.Models.Company, bool>> GetQueryExpression(PageInfo<Model.Models.Company> pageInfo, PageparamInfo pageParam)
        {
            ...
            predicateAnd = predicateAnd.And(a => a.Ctype == 0 && a.IsDelete == 0);
            ...
            if (!string.IsNullOrEmpty(pageParam.keyWord) && pageParam.keyWord.ToLower()!= "undefined")
            {
              ...
              //  predicateOr = predicateOr.Or(a => a.Code.Contains(pageParam.keyWord));
                //predicateOr = predicateOr.Or(a => a.Code != ""?a.Code.Contains(pageParam.keyWord):false );
                predicateOr = predicateOr.Or(a => a.Code == null ? false :a.Code.Contains(pageParam.keyWord) );
        ...
        [NfCustomActionFilter("删除客户", OptionLogTypeEnum.Del, "删除客户", false)]
        /// <summary>
        /// 软删除
        /// </summary>
        /// <returns></returns>
        public IActionResult Delete1(string Ids)
        {
           ...
           var permiision= _ISysPermissionModelService.GetCmpDeletePermission("deletecustomer", this.SessionCurrUserId, this.SessionCurrUserDeptId, listIds);
        ...
        public IActionResult Delete(string Ids)
        {
            ...
            if (usname == -10000)
            {
                ...
                {
                    resinfo.Msg = "选中的客户还有合同存在，请删除对应的合同后在尝试删除";
                    resinfo.Data = Ids;
                    resinfo.RetValue = 1;
                }
            }
        ...
        public IActionResult ExportExcel(ExportRequestInfo exportRequestInfo)
        {
            ...
            var downInfo= ExportDataHelper.ExportExcelExtend(exportRequestInfo,"客户", layPage.data);
