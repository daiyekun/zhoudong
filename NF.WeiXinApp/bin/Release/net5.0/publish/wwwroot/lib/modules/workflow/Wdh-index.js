...
var $url = woowx.constant.APIBaseURL + "/api/WorkFlow/WxWtg";
var pagesize = woowx.constant.page;//每页数据条数
var page = 1;
var maxpage;
var HtTye = $("#wshenpiType").val();
var Wxz = $('#Wx').val();
var flag = true;
var $kekword = "";
/**
...
function ajaxpage1(spage) {
    ...
    $.ajax({
        type: "GET",
        url: $url,
        data: { "page": page, "limit": pagesize, "keyWord": $kekword, "Wxzh": Wxz, "type": HtTye},
        // data: { "page": spage, "limit": pagesize, "keyWord": $kekword, "wxzh": Wxz, "type": HtType },
        dataType: 'json',
...
//    var type = $("#wshenpiType").val();

//    var ds = { "page": page, "limit": pagesize, "keyWord": $we, "Wxzh": Wxz, "type": type };
