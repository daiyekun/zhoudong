  ...
  var mod = {
    ...
    showConditionBoard: function (myTable) {
      ...
      filterBoard.push('<div class="soul-edit-out">')
        filterBoard.push('<div class="layui-form" lay-filter="soul-edit-out">')//<a class="layui-btn layui-btn-sm" data-type="addOne"><i class="layui-icon layui-icon-add-1"></i> 添加条件</a>
      filterBoard.push('<div><a class="layui-btn layui-btn-sm" data-type="addGroup"><i class="layui-icon layui-icon-add-circle" ></i> 添加分组</a><a class="layui-btn layui-btn-sm" data-type="search" style="float: right"><i class="layui-icon layui-icon-search"></i> 查询</a><span style="float: right"><input type="checkbox" lay-filter="out_auto" class="out_auto" title="实时更新"></span></div>')
      filterBoard.push('<hr>')
      filterBoard.push('<ul>')
      for (i = 0; i < filterSos.length; i++) {
