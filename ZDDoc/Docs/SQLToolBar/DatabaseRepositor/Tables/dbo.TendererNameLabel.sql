...
GO
ALTER TABLE [dbo].[TendererNameLabel] WITH NOCHECK ADD CONSTRAINT [FK_TendererNameLabel_TenderInfor] FOREIGN KEY ([TenderId]) REFERENCES [dbo].[TenderInfor] ([Id]) NOT FOR REPLICATION
GO
