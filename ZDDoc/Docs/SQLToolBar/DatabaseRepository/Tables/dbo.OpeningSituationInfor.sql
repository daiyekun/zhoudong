...
ALTER TABLE [dbo].[OpeningSituationInfor] WITH NOCHECK ADD
CONSTRAINT [FK_OpeningSituationInfor_OpeningSituationInfor] FOREIGN KEY ([LnquiryId]) REFERENCES [dbo].[Inquiry] ([Id]) NOT FOR REPLICATION
ALTER TABLE [dbo].[OpeningSituationInfor] NOCHECK CONSTRAINT [FK_OpeningSituationInfor_OpeningSituationInfor]
ALTER TABLE [dbo].[OpeningSituationInfor] WITH NOCHECK ADD
CONSTRAINT [FK_OpeningSituationInfor_TenderInfor1] FOREIGN KEY ([TenderId]) REFERENCES [dbo].[TenderInfor] ([Id]) NOT FOR REPLICATION
ALTER TABLE [dbo].[OpeningSituationInfor] NOCHECK CONSTRAINT [FK_OpeningSituationInfor_TenderInfor1]
ALTER TABLE [dbo].[OpeningSituationInfor] WITH NOCHECK ADD
CONSTRAINT [FK_OpeningSituationInfor_TenderInfor] FOREIGN KEY ([Unit]) REFERENCES [dbo].[Company] ([Id]) NOT FOR REPLICATION
