...
ALTER TABLE [dbo].[Questioning] ADD
CONSTRAINT [FK_Questioning_UserInfor] FOREIGN KEY ([CreateUserId]) REFERENCES [dbo].[UserInfor] ([Id])
ALTER TABLE [dbo].[Questioning] ADD
CONSTRAINT [FK_Questioning_Department] FOREIGN KEY ([ContractExecuteBranch]) REFERENCES [dbo].[Department] ([Id])
ALTER TABLE [dbo].[Questioning] ADD
CONSTRAINT [FK_Questioning_ProjectManager] FOREIGN KEY ([ProjectName]) REFERENCES [dbo].[ProjectManager] ([Id])
GO
