...
{
    /// <summary>
    /// Copied from the Internet, No warranty is guaranteed.
    /// </summary>
    static public class DecimalToCHTString
    {
        private static char[] chnGenText = { '零', '一', '二', '三', '四', '五', '六', '七', '八', '九' };
        private static char[] chnGenDigit = { '十', '百', '千', '万', '亿' };

        private static char[] chnRMBText = { '零', '壹', '贰', '叁', '肆', '伍', '陆', '柒', '捌', '玖' };
        private static char[] chnRMBDigit = { '拾', '佰', '仟', '万', '亿' };
        private static char[] chnRMBUnit = { '角', '分' };
        ...
        static public String Convert(String strDigit, Boolean bToRMB)
        {
            if (CheckDigit(ref strDigit, bToRMB))                       //检查输入数字有效性
            {
                StringBuilder strResult = new StringBuilder();
                ExtractSign(ref strResult, ref strDigit, bToRMB);       //提取符号部分
                ConvertNumber(ref strResult, ref strDigit, bToRMB);     //提取并转换整数和小数部分
                return strResult.ToString();
            }
            else
            {
                throw new ArgumentException("Bad input decimal number string!");
            }
        }
        ...
        static private void ConvertNumber(ref StringBuilder strResult, ref String strDigit, Boolean bToRMB)
        {
            int indexOfPoint;
        ...
        /// <param name="bToRMB"></param>
        /// <returns></returns>
        static private bool CheckDigit(ref String strDigit, bool bToRMB)
        {
        ...
        /// <param name="strDigit"></param>
        /// <param name="bToRMB"></param>
        static private void ExtractSign(ref StringBuilder strResult, ref String strDigit, Boolean bToRMB)
        {
            // '+'在最前
        ...
        /// <param name="bToRMB"></param>
        /// <returns></returns>
        static private string ConvertIntegral(String strIntegral, Boolean bToRMB)
        {
            // 去掉数字前面所有的'0'
            // 并把数字分割到字符数组中
        ...
        /// <param name="bToRMB"></param>
        /// <returns></returns>
        static private string ConvertFractional(String strFractional, Boolean bToRMB)
        {
