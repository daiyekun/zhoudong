...
layui.define(['table', 'form'], function (exports) {
    ...
    var contId2 = wooutil.getUrlVar('Id2');//比较合同ID
    ...
    table.render({
      ...
      table.render({
        elem: '#NF-ContSubHistoryTwo'
           , url: '/Contract/ContractChange/GetSubMatterHistoryList?contId=' + contId2 + '&rand=' + wooutil.getRandom()
           , defaultToolbar: ['filter']
           , cols: [subcols]
           , page: true
           , loading: true
    ...
    /**************************************计划资金-begin******************************************************/
      var plancols=[
       ...
       table.render({
              elem: '#NF-ContPlanceHistoryTwo'
              , url: '/Contract/ContractChange/GetPlanceHistoryList?contId=' + contId2 + '&rand=' + wooutil.getRandom()
              , defaultToolbar: ['filter']
              , cols: [plancols]
              , page: false
              , loading: true
    ...
    table.render({
        elem: '#NF-ContTextHistoryTwo'
           , url: '/Contract/ContractChange/GetContTextHistoryList?contId=' + contId2 + '&rand=' + wooutil.getRandom()
           , defaultToolbar: ['filter']
           , cols: [conttxtcols]
           , page: false
           , loading: true
    ...
    table.on('tool(NF-ContTextHistoryTwo)', function (obj) {
        var _data = obj.data;
        switch (obj.event) {
            case 'download'://下载
                contTextHisEvent.tooldownload(obj);
