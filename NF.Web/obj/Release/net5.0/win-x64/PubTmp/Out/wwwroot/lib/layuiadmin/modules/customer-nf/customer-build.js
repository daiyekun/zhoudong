...
layui.define(['table', 'form'], function (exports) {
    ...
    table.render({
        elem: '#NF-customer-build-otherContact'
           ...
           , cols: [[
               ...
               , { title: '操作', width: 150, align: 'center', fixed: 'right', toolbar: '#table-customer-otherContactbar' }
           ]]
           , page: false
           , loading: true
    ...
    var contactEvent = {
            ...
            , yes: function (index, layero) {
                ...
                iframeWindow.layui.form.on('submit(' + submitID + ')', function (obj) {
                    wooutil.OpenSubmitForm({
                        ...
                        table: table,
                        index: index,
                        tableId: 'NF-customer-build-otherContact'
                    });
                    return false;
                });
        ...
        batchdel: function () {
            ...
            wooutil.deleteDatas({ tableId: 'NF-customer-build-otherContact', url: '/Company/CompContact/Delete', nopage: true });
        },
        tooldel: function (obj) {
            /// <summary>列表操作栏-删除</summary>
            ///<param name='obj'>删除数据对象</param>
            wooutil.deleteInfo({ tableId: "NF-customer-build-otherContact", data: obj, url: '/Company/CompContact/Delete', nopage: true });
    ...
    //其他联系人头部工具栏
    table.on('toolbar(NF-customer-build-otherContact)', function (obj) {
        switch (obj.event) {
            case 'add':
                contactEvent.add();
                break;
    ...
    //列表操作栏
    table.on('tool(NF-customer-build-otherContact)', function (obj) {
        var _data = obj.data;
        switch (obj.event) {
            case 'del':
    ...
    table.render({
        elem: '#NF-customer-build-CompAttachment'
           ...
           , cols: [[
               ...
               , { title: '操作', width: 220, align: 'center', fixed: 'right', toolbar: '#table-customer-CompAttachmentbar' }
           ]]
           , page: false
           , loading: true
           , height: setter.table.height_tab
    ...
    var attachmentEvent = {
            ...
            , yes: function (index, layero) {
                ...
                iframeWindow.layui.form.on('submit(' + submitID + ')', function (obj) {
                    wooutil.OpenSubmitForm({
                        ...
                        table: table,
                        index: index,
                        tableId: 'NF-customer-build-CompAttachment'
                    });
                    return false;
                });
        ...
        batchdel: function () {
            /// <summary>列表头部-批量删除</summary>
            wooutil.deleteDatas({ tableId: 'NF-customer-build-CompAttachment', table: table, url: '/Company/CompAttachment/Delete', nopage: true });
        },
    ...
    //附件头部工具栏
    table.on('toolbar(NF-customer-build-CompAttachment)', function (obj) {
        switch (obj.event) {
            case 'add':
                attachmentEvent.add();
                break;
    ...
    //列表操作栏
    table.on('tool(NF-customer-build-CompAttachment)', function (obj) {
        var _data = obj.data;
        switch (obj.event) {
            case 'del':
    ...
    table.render({
        elem: '#NF-customer-build-CompDescription'
           ...
           , cols: [[
             ...
             , { field: 'CreateUserDisplyName', title: '建立人', width: 120, hide: true }
               , { title: '操作', width: 150, align: 'center', fixed: 'right', toolbar: '#table-customer-CompDescriptionbar' }
           ]]
           , page: false
           , loading: true
           , height: setter.table.height_tab
    ...
    var descEvent = {
            ...
            , yes: function (index, layero) {
                ...
                iframeWindow.layui.form.on('submit(' + submitID + ')', function (obj) {
                    wooutil.OpenSubmitForm({
                        ...
                        table: table,
                        index: index,
                        tableId: 'NF-customer-build-CompDescription'
                    });
                    return false;
                });
        ...
        batchdel: function () {
            /// <summary>列表头部-批量删除</summary>
            wooutil.deleteDatas({ tableId: 'NF-customer-build-CompDescription', url: '/Company/CompDescription/Delete', nopage: true });
        },
        tooldel: function (obj) {
            /// <summary>列表操作栏-删除</summary>
            ///<param name='obj'>删除数据对象</param>
            wooutil.deleteInfo({ tableId: "NF-customer-build-CompDescription", data: obj, url: '/Company/CompDescription/Delete', nopage: true });
    ...
    //其他联系人头部工具栏
    table.on('toolbar(NF-customer-build-CompDescription)', function (obj) {
        switch (obj.event) {
            case 'add':
                descEvent.add();
                break;
    ...
    //列表操作栏
    table.on('tool(NF-customer-build-CompDescription)', function (obj) {
        var _data = obj.data;
        switch (obj.event) {
            case 'del':
