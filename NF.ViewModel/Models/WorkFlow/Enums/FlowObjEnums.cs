...
namespace NF.ViewModel.Models
{
    ...
    public  enum FlowObjEnums
    {
        ...
        /// 询价：8
        /// </summary>
        [EnumItemExAttribute(Value = 8, Desc = "询价", TypeValue = typeof(CommpanyFlowItemsEnum))]
            Inquiry= 8,
        /// <summary>
        /// 约谈：9
        /// </summary>
        [EnumItemExAttribute(Value = 9, Desc = "洽谈", TypeValue = typeof(CommpanyFlowItemsEnum))]
     Questioning = 9,
        /// <summary>
        /// 招标：10
        /// </summary>
        [EnumItemExAttribute(Value = 10, Desc = "招标", TypeValue = typeof(CommpanyFlowItemsEnum))]
        Tender = 10,
