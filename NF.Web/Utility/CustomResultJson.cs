...
{
    public class CustomResultJson : IActionResult
    {
        ...
        public CustomResultJson(object data)
        {
            _Data = data;
        }
        /// <summary>
        ...
        public CustomResultJson(object data,bool logdate)
        {
            _Data = data;
            _logdate = logdate;
        }
        ...
        public CustomResultJson(object data,Func<string,string> func, bool logdate=true)
        {
            _Data = data;
            _func = func;
            _logdate = logdate;
        ...
        public CustomResultJson(object data, bool logdate = false, bool keyL=false)
        {
            _Data = data;
            _logdate = logdate;
            _jsonKeylower = keyL;
