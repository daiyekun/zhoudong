...
GO
ALTER TABLE [dbo].[OpenBid] WITH NOCHECK ADD CONSTRAINT [FK_OpenBid_OpenBid] FOREIGN KEY ([QuesId]) REFERENCES [dbo].[Questioning] ([Id]) NOT FOR REPLICATION
GO
ALTER TABLE [dbo].[OpenBid] WITH NOCHECK ADD CONSTRAINT [FK_OpenBid_Company] FOREIGN KEY ([unit]) REFERENCES [dbo].[Company] ([Id]) NOT FOR REPLICATION
GO
